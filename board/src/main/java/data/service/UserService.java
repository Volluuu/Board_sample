...
public class UserService {
    ...
    public TokenDto tokenGenerator(String user_id) {
        ...
        .accessToken("Bearer" + jwtTokenProvider.createAcessToken(dto.getUser_id(), Collections.singletonList(dto.getAuth())))
        .refreshToken("Bearer" + jwtTokenProvider.createRefreshToken(dto.getUser_id(), Collections.singletonList(dto.getAuth())))
        .build();
    }
